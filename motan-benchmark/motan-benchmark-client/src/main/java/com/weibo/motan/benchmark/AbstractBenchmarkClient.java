...
public abstract class AbstractBenchmarkClient {
	...
	public void start(int concurrents, int runtime, String classname, String params) {
		...
		for (int i = 0; i < this.concurrents; i++) {
			ClientRunnable runnable = getClientRunnable(classname, params, cyclicBarrier, countDownLatch, startTime,
					endTime);
	...
	public abstract ClientRunnable getClientRunnable(String classname, String params, CyclicBarrier barrier,
