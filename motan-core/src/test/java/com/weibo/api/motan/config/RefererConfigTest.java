...
public class RefererConfigTest extends BaseTestCase {
	...
	public void testMultiProtocol() {
		List<ProtocolConfig> protocols = getMultiProtocols(MotanConstants.PROTOCOL_INJVM,
				MotanConstants.PROTOCOL_MOTAN);
		refererConfig.setProtocols(protocols);
		IWorld ref = refererConfig.getRef();
		assertNotNull(ref);
	...
	public void testMultiRegitstry() {
		List<RegistryConfig> registries = getMultiRegister(MotanConstants.REGISTRY_PROTOCOL_LOCAL,
				MotanConstants.REGISTRY_PROTOCOL_ZOOKEEPER);
