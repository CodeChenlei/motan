...
public class ServiceConfigTest extends BaseTestCase {
	...
	public void testMethodConfig() {
		...
		assertEquals(123, serviceUrl.getMethodParameter("world", "void", URLParamType.requestTimeout.getName(),
				URLParamType.requestTimeout.getIntValue()).intValue());
		assertEquals(456, serviceUrl
				.getMethodParameter("worldSleep", "java.lang.String,int", URLParamType.requestTimeout.getName(),
						URLParamType.requestTimeout.getIntValue()).intValue());
		assertEquals(1, serviceUrl
				.getMethodParameter("world", "void", URLParamType.retries.getName(), URLParamType.retries.getIntValue())
				.intValue());
		assertEquals(2, serviceUrl
				.getMethodParameter("worldSleep", "java.lang.String,int", URLParamType.retries.getName(),
	...
	public void testMultiProtocol() {
		...
		serviceConfig
				.setExport(MotanConstants.PROTOCOL_INJVM + ":" + 0 + "," + MotanConstants.PROTOCOL_MOTAN + ":8002");
		serviceConfig.export();
